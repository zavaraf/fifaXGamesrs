...
<%--                   </form> --%>
	...
	<img ng-src="https://www3.gobiernodecanarias.org/medusa/edublogs/ceipmariajesusramirezdiaz/files/2013/07/offline.jpg" style="width: 30%;"class="card-img-center" alt="...">
