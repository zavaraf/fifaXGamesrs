CREATE DATABASE  IF NOT EXISTS `fifaxgam_fifaxgamersbd` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `fifaxgam_fifaxgamersbd`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 173.243.120.250    Database: fifaxgam_fifaxgamersbd
-- ------------------------------------------------------
...
CREATE TABLE `equipos` (
  ...
  `linksofifa` varchar(200) DEFAULT NULL,
...
CREATE TABLE `equipos_has_imagen` (
  ...
  `idTemporada` int(11) NOT NULL DEFAULT '8',
  PRIMARY KEY (`equipos_idEquipo`,`tipoImagen_idTipoImagen`,`idTemporada`),
  ...
  KEY `fk_euipos_has_tipoImagen_temporadad1_idx` (`idTemporada`),
  ...
  CONSTRAINT `fk_euipos_has_tipoImagen_temporadad1` FOREIGN KEY (`idTemporada`) REFERENCES `temporada` (`idTemporada`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12989 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `persona_has_temporada`
--

DROP TABLE IF EXISTS `persona_has_temporada`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `persona_has_temporada` (
  `persona_idPersona` int(11) NOT NULL,
  `temporada_idTemporada` int(11) NOT NULL,
  `rating` varchar(45) DEFAULT NULL,
  `equipos_idEquipo` int(11) NOT NULL,
  PRIMARY KEY (`persona_idPersona`,`temporada_idTemporada`,`equipos_idEquipo`),
  KEY `fk_persona_has_temporada_temporada1_idx` (`temporada_idTemporada`),
  KEY `fk_persona_has_temporada_persona1_idx` (`persona_idPersona`),
  KEY `fk_persona_has_temporada_equipos1_idx` (`equipos_idEquipo`),
  CONSTRAINT `fk_persona_has_temporada_equipos1` FOREIGN KEY (`equipos_idEquipo`) REFERENCES `equipos` (`idEquipo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_persona_has_temporada_persona1` FOREIGN KEY (`persona_idPersona`) REFERENCES `persona` (`idPersona`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_persona_has_temporada_temporada1` FOREIGN KEY (`temporada_idTemporada`) REFERENCES `temporada` (`idTemporada`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-02-17 19:25:55
